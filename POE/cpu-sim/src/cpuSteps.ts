...
export const CPU_STEPS: CpuStepDef[] = [
  ...
  // 6 — write result to Rd
  {
    ...
    activeRamRow: false, activeConnections: [], activeRegisters: [],
    animateR0: true,
    displayPc: '0x02', displayIr: '0x2017', displayOpcode: 'LD', displayOperands: 'R0, 0x09', displayR0: '0x17', displayFlags: false,
  },
  // 7 — update SREG
  {
    ...
    displayPc: '0x02', displayIr: '0x2017', displayOpcode: 'LD', displayOperands: 'R0, 0x09', displayR0: '0x17', displayFlags: true,
  },
];
